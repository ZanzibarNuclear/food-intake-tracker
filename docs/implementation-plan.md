...
| `server/data/system-foods.json` | Starter catalog (370 foods) | **Expand soon** via FDA/USDA bulk import |
...
- Starter catalog has **370 common foods** with calories, protein, nutrition score, and satiety score.
...
Source and format strategy is documented in [`docs/catalog-import-strategy.md`](./catalog-import-strategy.md).
...
- Build `tools/fetch_system_foods.py` or equivalent and expand `server/data/system-foods.json` from 370 starter items to a few thousand FDA/USDA-backed items.
...
| Question | Default |
|----------|---------|
| Catalog size for v1 | Starter 370 now; import a few thousand FDA/USDA foods soon |
